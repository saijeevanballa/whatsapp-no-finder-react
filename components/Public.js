      ...
      <div key={val._id} className="d-flex justify-content-around publicMain flex-wrap">
        <div className="card">
          <div className="card-body">
            ...
            <p className="card-text">{val.name || "anonymous"}</p>
            <div className="d-flex flex-row justify-content-start flex-wrap">
              ...
              <div>
                <a onClick={() => this.handlerDisLike(val._id)} className="btn btn-primary btn-dislike m-1">
                  <div className="d-flex flex-row justify-content-between">
              ...
              <div>
                <a onClick={() => this.handlerView(val._id, val.number)}  className="btn btn-primary btn-view m-1">
                  <div className="d-flex flex-row justify-content-between">
